...
public class Servlets {
	...
	public static final String getParamStr(HttpServletRequest request, String name) {
		return request.getParameter(name);
	}

	/**
	 * 等于 1 或 true，返回 true, 其它为 false;
	 * @param request
	 * @param name
	 * @return
	 */
	public static final boolean isTrueParam(HttpServletRequest request, String name, boolean empty) {
