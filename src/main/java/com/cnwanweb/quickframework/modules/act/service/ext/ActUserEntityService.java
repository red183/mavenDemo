...
package com.cnwanweb.quickframework.modules.act.service.ext;
...
import com.cnwanweb.quickframework.modules.act.utils.ActUtils;
...
//		}
        ...
        if (user != null) {
            getSystemService().deleteUser(new com.cnwanweb.quickframework.modules.sys.entity.User(user.getId()));
        }
    }
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
        ...
        for (Role role : getSystemService().findRole(new Role(new com.cnwanweb.quickframework.modules.sys.entity.User(null, userId)))){
