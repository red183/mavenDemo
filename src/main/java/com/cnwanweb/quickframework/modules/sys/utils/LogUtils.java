...
import com.cnwanweb.quickframework.common.utils.Exceptions;
...
import com.cnwanweb.quickframework.modules.sys.dao.LogDao;
...
//			if(StringUtils.isNotBlank(title) && systemService != null) {
//				List<Menu> menus = systemService.findAllMenu();
//				String ctx = request.getContextPath();
//				for(Menu menu : menus) {
//					if(menu.getIsShow().equals("1")) {
//						String href = menu.getHref();
//						if(StringUtils.isNotBlank(href) && log.getRequestUri().endsWith(href)) {
//
//						}
//					}
//				}
