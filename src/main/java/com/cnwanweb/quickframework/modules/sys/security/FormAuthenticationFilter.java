...
public class FormAuthenticationFilter extends org.apache.shiro.web.filter.authc.FormAuthenticationFilter {
    ...
    public static final String DEFAULT_CAPTCHA_ISAPPLOGIN = "IS_APP_LOGIN";
    ...
    protected AuthenticationToken createToken(ServletRequest request, ServletResponse response) {
        ...
        String captcha = DEFAULT_CAPTCHA_ISAPPLOGIN;
        ...
        AuthenticationToken authToken = new UsernamePasswordToken(username, password.toCharArray(), rememberMe, host, captcha, mobile);
        return authToken;
    }
