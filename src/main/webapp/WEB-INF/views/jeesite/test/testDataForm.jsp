...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctxAdmin}/test/testData/">单表列表</a></li>
		<li class="active"><a href="${ctxAdmin}/test/testData/form?id=${testData.id}">单表<shiro:hasPermission name="test:testData:edit">${not empty testData.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="test:testData:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
