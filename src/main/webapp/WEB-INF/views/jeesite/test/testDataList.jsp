...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctxAdmin}/test/testData/">单表列表</a></li>
		<shiro:hasPermission name="test:testData:edit"><li><a href="${ctxAdmin}/test/testData/form">单表添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="testData" action="${ctxAdmin}/test/testData/" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="testData">
			<tr>
				<td><a href="${ctxAdmin}/test/testData/form?id=${testData.id}">
					${testData.user.name}
				</a></td>
				<td>
				...
				<shiro:hasPermission name="test:testData:edit"><td>
    				<a href="${ctxAdmin}/test/testData/form?id=${testData.id}">修改</a>
					<a href="${ctxAdmin}/test/testData/delete?id=${testData.id}" onclick="return confirmx('确认要删除该单表吗？', this.href)">删除</a>
