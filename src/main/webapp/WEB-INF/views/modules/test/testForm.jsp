...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctxAdmin}/test/test/">硕正列表</a></li>
		<li class="active"><a href="${ctxAdmin}/test/test/form?id=${test.id}">组件<shiro:hasPermission name="test:test:edit">${not empty test.id?'修改':'表单'}</shiro:hasPermission><shiro:lacksPermission name="test:test:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="test" action="${ctxAdmin}/test/test/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
